...
backup_menu() {
  while true; do
    ...
    printf '  [01] Buat backup Panel\n  [02] Lihat daftar backup\n  [03] Cek file backup\n  [00] Kembali\n\n'
    ...
    case "$choice" in
      ...
      3|03)
        ...
        [[ -f "$file" ]] && tar -tzf "$file" >/dev/null && ui_success 'File backup masih bisa dibaca.' || ui_error 'File backup tidak bisa diverifikasi.';;
      0|00) return;;
      *) ui_warning 'Pilihan itu belum tersedia. Coba pilih nomor yang ada.';;
    esac
  done
}
