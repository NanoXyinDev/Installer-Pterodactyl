...
for f in lib/ui.sh lib/detect.sh lib/system.sh lib/panel.sh modules/wings.sh modules/node.sh modules/allocation.sh modules/theme.sh modules/protection.sh modules/antiflood.sh modules/roles.sh modules/disk-guard.sh modules/doctor.sh modules/backup.sh modules/compatibility.sh modules/auto-node.sh; do
