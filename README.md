...
- refreshed legacy login/authentication screen with glass UI and cache-busted theme assets
...
- `ZXV OFFICIAL` stays centered in the header on desktop and mobile layouts.
