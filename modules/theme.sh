...
THEME_BACKGROUND_SOURCE="$(cd "$(dirname "${BASH_SOURCE[0]}")/../themes/panel" && pwd)/background.jpg"
THEME_BACKGROUND_PATH="public/zxvcode/background.jpg"
...
install_theme() {
  ...
  install -m 0644 "$THEME_BACKGROUND_SOURCE" "$panel/$THEME_BACKGROUND_PATH"
...
PYTHON
  then
    ...
    rm -rf "$tx"
    rm -f "$panel/$THEME_PATH" "$panel/$THEME_JS_PATH" "$panel/public/zxvcode/mark.svg" "$panel/$THEME_BACKGROUND_PATH"
