...
node_menu(){
  while true; do
    ...
    ui_info 'Wings installer is available from Main Menu > [02] to avoid duplicate commands.'
    printf '  [01] Atur profil Node\n  [02] Buat lokasi lewat Artisan\n  [03] Lihat profil Node\n  [04] Buat lokasi + node otomatis\n  [00] Kembali\n\n'
    read -r -p '  Select › ' n
    case "$n" in
      1) node_profile;;
      2) create_location;;
