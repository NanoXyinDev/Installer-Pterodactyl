...
@section('content-header')
    <h1>Buat server<small>Tambahkan server baru ke Panel.</small></h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="pName">Nama server</label>
                            <input type="text" class="form-control" id="pName" name="name" value="server" readonly>
                            <p class="small text-muted no-margin"><code>server</code> adalah satu-satunya nama server yang diperbolehkan.</p>
                        </div>

<div class="form-group">
    <label for="pUserId">Pemilik server</label>
    ...
    @endif
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="pDescription" class="control-label">Deskripsi server</label>
                        ...
                        <div class="form-group">
                            <div class="checkbox checkbox-primary no-margin-bottom">
                                ...
                                <label for="pStartOnCreation" class="strong">Jalankan server setelah selesai dibuat</label>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-footer">
                    {!! csrf_field() !!}
                    <input type="submit" class="btn btn-success pull-right" value="Buat server" />
                </div>
            </div>
        </div>
    </div>
...
// Persist 'Pemilik server' select2
// (Removed because Pemilik server now auto-fills based on logged-in user)
// END Persist 'Pemilik server' select2
