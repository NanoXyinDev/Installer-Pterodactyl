...
ui_header(){ printf '%b\n' "${C}╭──────────────────────────────────────────────────────────╮${R}" "${C}│${R}  ${W}ZxvCode${R} / ${B}PTERODACTYL INSTALLER${R}                 ${C}│${R}" "${C}│${R}  ${D}Panel setup • Appearance • Protection${R} ${C}│${R}" "${C}╰──────────────────────────────────────────────────────────╯${R}"; }
...
ui_farewell(){
  printf '\n'
  printf '%b\n' "${C}╭──────────────────────────────────────────────────────────╮${R}"
  printf '%b\n' "${C}│${R}  ${W}ZXVCODE UPDATE SELESAI${R}                            ${C}│${R}"
  printf '%b\n' "${C}│${R}  ${D}Terima kasih sudah menggunakan ZxvCode.${R}          ${C}│${R}"
  printf '%b\n' "${C}│${R}  ${G}Panel aman • UI stabil • Selamat menggunakan!${R}   ${C}│${R}"
  printf '%b\n' "${C}╰──────────────────────────────────────────────────────────╯${R}"
  printf '\n'
}
ui_section(){ printf '\n  %b\n  %b\n' "${W}$*${R}" "${D}────────────────────────────────────────────────────────${R}"; }
